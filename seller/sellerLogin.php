...
if (!empty($_POST)) {
    ...
    $response = $sellerManager->sellerLogin($email, $password);
    echo $response;
}
    ...
    <style>
        ...
        * {
        ...
        .form {
            ...
            padding: 30px;
            border-radius: 6px;
            background: linear-gradient(to right, #8B8ABB, #8AC59D);
        }
    ...
    <section class="container forms">
        <div class="form login">
            <div class="form-content">
                ...
                <div class="form-link">
                    <span>Don't have an account? <a href="sellerRegister.php" class="link signup-link">Signup</a></span>
                </div>
            </div>
