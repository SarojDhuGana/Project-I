...
!empty($_POST['full_name'])) {
    ...
    $response = $adminManager->createAdmin($password, $email, $full_name);
    echo $response;
} else {
            ...
            <div class="form-content">
                ...
                <form action="" method="post">
                    ...
                    <div class="field input-field">
                        <input type="text" name="full_name" value="<?= isset($_POST['full_name'])?$_POST['full_name']:"";?>" placeholder="Full name" class="input">
                    </div>
                    <div class="field input-field">
                        <input type="email" name="email" value="<?= isset($_POST['email'])?$_POST['email']:"";?>" placeholder="Email" class="input">
                    </div>
                    ...
                    <div class="field input-field">
                        <input type="password" name="confirm_password" placeholder=" Comfirm Password" class="password">
                ...
                <div class="form-link">
                    <span>Already have an account?<a href="index.php" class="signup-link">Login</a></span>
                </div>
            </div>
